    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('health_status', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='health_status', to='rporterGeoSpatial.healthstatus')),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='em_user', to=settings.AUTH_USER_MODEL)),
            ],
            options={
